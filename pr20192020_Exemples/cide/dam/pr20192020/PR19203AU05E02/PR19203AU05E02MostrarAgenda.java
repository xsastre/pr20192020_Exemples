...
public class PR19203AU05E02MostrarAgenda extends JFrame
{
	private PR19203AU05E02Persona currentEntry;
	private PR19203AU05E02Queries personQueries;
	...
	// constructor
	public PR19203AU05E02MostrarAgenda()
	{
		super("Agenda");
		// establish database connection and set up PreparedStatements
		personQueries = new PR19203AU05E02Queries();
		// create GUI
	...
	{
		new PR19203AU05E02MostrarAgenda();
	}
